        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Total Users {{ count($users) }}</p>
                </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            {{-- <th class="p-4">Email Verified At</th> --}}
                    ...
                    <tbody class="text-white">
                        @foreach ($users as $user)
                            <tr class="border-t dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                {{-- <td class="p-4">{{ $user->email_verified_at->format('d M Y') }}</td> --}}
